...
%token COMMA NUMBER COMMENT INT CHAR SHORT LONG VOID FLOAT DOUBLE
%token FOR STRUCT PRINT PRINTF SCANF WHILE IF ELSE BREAK CONTINUE
%token TRUE FALSE RETURN IMPORT SEMICOLON COLON ASSIGN PLUS PLUSPLUS
%token MINUS MINUSMINUS TIMES DIVIDE REST_OF_DIVISION GT LT LE GE EQ NE
%token LEFT_PARENTHESIS RIGHT_PARENTHESIS LEFT_BRACKET RIGHT_BRACKET
%token LEFT_BRACE RIGHT_BRACE LOGIC_AND LOGIC_OR NOT ID
